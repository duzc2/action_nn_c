...
#define CNN_MAX_SEQUENCE_LENGTH 8U
#define CNN_MAX_FRAME_WIDTH 16U
#define CNN_MAX_FRAME_HEIGHT 16U
#define CNN_MAX_CHANNEL_COUNT 4U
#define CNN_MAX_FILTER_COUNT 8U
#define CNN_MAX_FEATURE_COUNT 8U
#define CNN_MAX_KERNEL_SIZE 5U
#define CNN_MAX_TOTAL_INPUT_SIZE \
    (CNN_MAX_SEQUENCE_LENGTH * CNN_MAX_FRAME_WIDTH * CNN_MAX_FRAME_HEIGHT * CNN_MAX_CHANNEL_COUNT)
#define CNN_MAX_TOTAL_OUTPUT_SIZE (CNN_MAX_SEQUENCE_LENGTH * CNN_MAX_FEATURE_COUNT)
